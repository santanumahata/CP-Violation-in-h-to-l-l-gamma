...
C     
C     Process: h > mu+ mu- a NP=0 $$ e+ mu+ e- mu- a @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
        IF(MDL_WZ1.NE.0D0) FK_MDL_WZ1 = SIGN(MAX(ABS(MDL_WZ1),
     $    ABS(MDL_MZ1*SMALL_WIDTH_TREATMENT)), MDL_WZ1)
      ENDIF
      ...
      CALL FFV1_3_3(W(1,2),W(1,3),GC_6187,GC_5910,MDL_MZ, FK_MDL_WZ
     $ ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,4),W(1,5),W(1,1),GC_6361,AMP(1))
      CALL FFV1_3PZ1_3(W(1,2),W(1,3),GC_6308,GC_6173,MDL_MZ1,
     $  FK_MDL_WZ1,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS4_0(W(1,4),W(1,5),W(1,1),GC_6379,AMP(2))
