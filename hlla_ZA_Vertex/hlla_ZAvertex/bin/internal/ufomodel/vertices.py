...
V_3 = Vertex(name = 'V_3',
             ...
             couplings = {(0,0):C.GC_85,(0,1):C.GC_84})

V_4 = Vertex(name = 'V_4',
             particles = [ P.W__minus__, P.W__plus__, P.H ],
             color = [ '1' ],
             lorentz = [ L.VVS1, L.VVS4, L.VVS5 ],
             couplings = {(0,0):C.GC_87,(0,2):C.GC_86,(0,1):C.GC_1})
...
V_6 = Vertex(name = 'V_6',
             ...
             couplings = {(0,0):C.GC_31,(0,1):C.GC_34,(0,4):C.GC_33,(0,3):C.GC_25,(0,2):C.GC_30})

V_7 = Vertex(name = 'V_7',
             particles = [ P.a, P.Z, P.H ],
             color = [ '1' ],
             lorentz = [ L.VVS1, L.VVS5 ],
             couplings = {(0,0):C.GC_89,(0,1):C.GC_88})

V_8 = Vertex(name = 'V_8',
             particles = [ P.W__minus__, P.W__plus__, P.Z ],
             color = [ '1' ],
             lorentz = [ L.VVV2, L.VVV4, L.VVV6, L.VVV7, L.VVV8, L.VVV9 ],
             couplings = {(0,0):C.GC_53,(0,1):C.GC_55,(0,5):C.GC_54,(0,4):C.GC_49,(0,2):C.GC_51,(0,3):C.GC_52})

V_9 = Vertex(name = 'V_9',
             particles = [ P.Z, P.Z, P.H ],
             color = [ '1' ],
             lorentz = [ L.VVS3, L.VVS4, L.VVS6 ],
             couplings = {(0,0):C.GC_91,(0,2):C.GC_90,(0,1):C.GC_35})
