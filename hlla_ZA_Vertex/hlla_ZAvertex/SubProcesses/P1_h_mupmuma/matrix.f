...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3_3(W(1,2),W(1,3),GC_61,GC_58,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS1_5_0(W(1,4),W(1,5),W(1,1),GC_89,GC_88,AMP(1))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_24,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS2_5_0(W(1,5),W(1,4),W(1,1),GC_85,GC_84,AMP(2))
