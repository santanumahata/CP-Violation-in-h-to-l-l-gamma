...
C     ----------
     ...
     $    ABS(MDL_MZ1*SMALL_WIDTH_TREATMENT)), MDL_WZ1)
      ...
      CALL FFV1_3_4_3(W(1,2),W(1,3),GC_6348,GC_6341,GC_6345,MDL_MZ,
     $  FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,4),W(1,5),W(1,1),GC_6365,AMP(1))
      CALL FFV1_3PZ1_3(W(1,2),W(1,3),GC_6294,GC_6162,MDL_MZ1,
     $  FK_MDL_WZ1,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS4_0(W(1,4),W(1,5),W(1,1),GC_6383,AMP(2))
