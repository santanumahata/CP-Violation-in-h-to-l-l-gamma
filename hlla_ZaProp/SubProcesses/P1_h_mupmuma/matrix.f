...
C     
C     Process: h > mu+ mu- a NP<=1 $$ e+ mu+ e- mu- @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      DATA (NHEL(I,   1),I=1,4) / 0, 1,-1,-1/
      DATA (NHEL(I,   2),I=1,4) / 0, 1,-1, 1/
      DATA (NHEL(I,   3),I=1,4) / 0, 1, 1,-1/
      DATA (NHEL(I,   4),I=1,4) / 0, 1, 1, 1/
      DATA (NHEL(I,   5),I=1,4) / 0,-1,-1,-1/
      DATA (NHEL(I,   6),I=1,4) / 0,-1,-1, 1/
      DATA (NHEL(I,   7),I=1,4) / 0,-1, 1,-1/
      DATA (NHEL(I,   8),I=1,4) / 0,-1, 1, 1/
      DATA IDEN/ 1/
C     ----------
C     BEGIN CODE
C     ----------
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3_3(W(1,2),W(1,3),GC_14,GC_15,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,4),W(1,5),W(1,1),GC_36,AMP(1))
      CALL FFV2_3_3(W(1,2),W(1,3),GC_59,GC_56,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,4),W(1,5),W(1,1),GC_85,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,4),W(1,5),W(1,1),GC_36,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,4),W(1,5),W(1,1),GC_84,AMP(4))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_24,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL VVS4_0(W(1,5),W(1,4),W(1,1),GC_35,AMP(5))
